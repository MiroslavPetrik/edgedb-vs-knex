...
declare type var_e437b85b50cc11edb0dda94b0d66a6deλFuncExpr<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
> = $.$expr_Function<
  _std.$number, $.cardutil.overrideLowerBound<$.Cardinality.One, 'Zero'>
>;
declare type var_e437b85b50cc11edb0dda94b0d66a6deλFuncExpr2<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>,
> = $.$expr_Function<
 ...
 */
declare function var_e437b85b50cc11edb0dda94b0d66a6de<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
>(
  vals: P1,
): var_e437b85b50cc11edb0dda94b0d66a6deλFuncExpr<P1>;
/**
 * Return the sample variance of the input set.
 */
declare function var_e437b85b50cc11edb0dda94b0d66a6de<
...
>(
  vals: P1,
): var_e437b85b50cc11edb0dda94b0d66a6deλFuncExpr2<P1>;
...
declare type __defaultExports = {
  ...
  "var": typeof var_e437b85b50cc11edb0dda94b0d66a6de;
