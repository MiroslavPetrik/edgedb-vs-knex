...
export declare type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$TaskStatus ? _default.$TaskStatus : 
  T extends _default.$TaskActionKind ? _default.$TaskActionKind : 
...
declare type getSharedParentScalar<A, B> =
  ...
  A extends _schema.$AccessKind ?
    ...
    never
  :
  A extends _default.$TaskStatus ?
    B extends _default.$TaskStatus ?
    B
    :
    never
  :
  A extends _default.$TaskActionKind ?
    B extends _default.$TaskActionKind ?
    B
    :
    never
  :
