...
export interface Timestamps extends std.$Object {
  "createdAt": Date;
  "updatedAt": Date;
}
export interface Task extends Timestamps {
  ...
  "dueAt": Date;
  "title": string;
  "lastNotificationEvent"?: TaskNotificationEvent | null;
  "lastSeenEvent"?: TaskSeenEvent | null;
  "hasNotification"?: boolean | null;
  "lastAction"?: TaskAction | null;
  "status"?: TaskStatus | null;
}
export interface TaskNotificationEvent extends Timestamps {
  "task": Task;
  "user": User;
}
export interface TaskAction extends TaskNotificationEvent {
  "kind": TaskActionKind;
  "reason"?: string | null;
}
export type TaskActionKind = "Opened" | "Closed" | "Edited";
export interface TaskComment extends TaskNotificationEvent {
  "note": string;
}
export interface TaskSeenEvent extends Timestamps {
  "task": Task;
  "user": User;
}
